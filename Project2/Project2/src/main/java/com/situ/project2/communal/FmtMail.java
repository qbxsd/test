...
public class FmtMail {
    ...
    public static void main(String[] args) throws MessagingException {
        String[] to = { "1353276013@qq.com" };// 收件人
        String from = "1423757343@qq.com";// 发件人
        String pass = "mrmtejknofqpbafb";
        String hostSend = "smtp.qq.com";
        String portSend = "587";
        FmtMail ms = new FmtMail(to, from, pass, hostSend, portSend);
        ms.send("AAA", "BBB");//主题   内容
    }
}
...
class MailReceives {
    public static void main(String[] args) throws Exception {
        ...
        String username = "1423757343@qq.com";
        String password = "pmkigmlnkeixhddb"; // QQ邮箱的SMTP的授权码，什么是授权码，它又是如何设置？
